    ...
    */
    ...
    public function saveNewData($jsonData){
        try{
            ...
            // return $dataToJson;
           return $this->response->error_201();

        }catch(Exception $e){
           return $this->response->error_200('Error al almacenar la información');
        }
    }
     ...
     * 
     * @param string jsonData the json data that is sent from the client side.
     */
    public function updateEntry($jsonData){
        try{
            ...
            return $this->response->error_201("Datos actualizados correctamente");
        }catch(Exception $e){
    ...
    */
    public function deleteEntry($jsonData){
        try{
            ...
            //Cambiar por respuesta http
            // print($fullDataToJson);
            return $this->response->error_200('Elemento eliminado correctamente');

        }catch(Exception $e){
            return $this->response->error_200('Error al eliminar el elemento');
        }
